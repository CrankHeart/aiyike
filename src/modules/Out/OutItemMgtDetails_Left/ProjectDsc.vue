		...
		<section class="inner">
			...
			<table>
				...
				<tr v-if="HasPermission('projectDscContractMoney')">
					...
					<td class="text">{{contractMoney | nullformat}}</td>
				</tr>
				<tr>
					<td class="tip">客户公司:</td>
					<td class="text">{{details.customerbus && details.customerbus.name}}</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="text">{{details.user && details.user.mobile | nullformat}}</td>
				</tr>
				<tr>
					<td class="tip">联系邮箱:</td>
					<td class="text">{{details.user && details.user.email | nullformat}}</td>
				</tr>
				<tr>
					<td class="tip">资料库:</td>
		...
		computed: {
			...
			contractMoney(){
				...
				if(parseInt(this.details.category)==2){
					if(parseInt(this.details.itemRequireTotalMoney)!=0){
