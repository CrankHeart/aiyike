    ...
    export default {
        ...
        methods: {
            ...
            getSearchWiListData(){
                ...
                this.$http.post('/api/week/weekItem', sendData, {emulateJSON: true})
                    .then((res) => {
                        var data = res.data
                        if(data.success) {
            ...
            soso(){
                ...
                this.$http.post('/api/week/weekItem', this.datalistData, {emulateJSON: true})
                    .then((res) => {
                        var data = res.data;
                        if(data.success) {
