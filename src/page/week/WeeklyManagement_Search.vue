		...
		<section class="layout-list">
			<el-form :model="formInline" class="soso clearfix margin-left8" label-width="68px">
				...
				<el-form-item class="label inlineblock marginLeft18 form190" label="周报类型：">
					<el-select v-model="formInline.weeklyTypeValue" class="label select-wrap" clearable placeholder="选择周报类型" v-sicon1  @change="showPName">
				...
				<!--<div class="clearfix">-->
					<el-form-item class="label inlineblock  form190" label="项目名称：" v-if="showProjectName">
						<el-select v-model="formInline.entryNameValue"  class="select-wrap proName" filterable clearable  multiple placeholder="选择项目名称"  v-sicon1>
